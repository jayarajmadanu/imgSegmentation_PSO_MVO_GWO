...
A = cv2.imread('../../images/horse.png', 0)
A = cv2.resize(A, (220, 220))
...
first = time.time()
max, s, t = PSO(100, 1, A, func=phi)
print('seconds took to complete ', time.time() - first)
...
cv2.imshow('Segmented img', A)
cv2.waitKey(0)

cv2.imwrite('../../images/psoOutput.jpg',A)
